  ...
  Future<void> _fetchDashboardData() async {
    ...
    final mockData = DashboardData(
      ...
      attendanceData: const [
        AttendanceData('Jan', 40, 8),
        AttendanceData('Feb', 42, 6),
        AttendanceData('Mar', 45, 3),
        AttendanceData('Apr', 46, 2),
        AttendanceData('May', 41, 7),
        AttendanceData('Jun', 44, 4),
        AttendanceData('Jul', 43, 5),
        AttendanceData('Aug', 47, 1),
        AttendanceData('Sep', 45, 3),
        AttendanceData('Oct', 46, 2),
        AttendanceData('Nov', 48, 0),
        AttendanceData('Dec', 42, 6),
      ],
      dcrData: const [
        MonthlyData('Jan', 120),
        MonthlyData('Feb', 150),
