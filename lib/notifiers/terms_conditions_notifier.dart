  ...
  void _loadMockData() async {
    ...
    state = const [
      ...
      TermsCondition(
        ...
        header: 'User Conduct',
        description:
            'You agree to use our services only for lawful purposes. You must not use the platform to transmit any material that is offensive, defamatory, or infringes on any intellectual property rights.',
      ),
      TermsCondition(
        id: '3',
        header: 'Intellectual Property',
        description:
            'All content included on this application, such as text, graphics, logos, and software, is the property of MR Corporation or its content suppliers and protected by international copyright laws.',
      ),
      TermsCondition(
        id: '4',
        header: 'Termination',
