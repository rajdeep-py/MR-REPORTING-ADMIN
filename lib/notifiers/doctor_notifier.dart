...
class DoctorState {
  ...
  final String filterSpecialization; // e.g. "All", "Cardiologist", "Neurologist", etc.
  ...
  void _loadMockData() async {
    ...
    state = state.copyWith(doctors: [
      const Doctor(
        ...
        profilePhotoPath: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=400&q=80',
        ...
        experience: '12 Years',
        description: 'Dr. Mitchell is a board-certified cardiologist with a special interest in preventive cardiology and heart failure management. She is known for her compassionate patient care.',
        chambers: [
          DoctorChamber(name: 'City Heart Clinic', phoneNo: '+1 234 567 8902', address: '45 Heart Lane, Cityville'),
          DoctorChamber(name: 'Northside General', phoneNo: '+1 234 567 8903', address: '100 Northside Rd, Cityville'),
        ],
      ),
      const Doctor(
        id: '2',
        name: 'Dr. James Wilson',
        profilePhotoPath: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&q=80',
        ...
        experience: '8 Years',
        description: 'Dr. Wilson specializes in treating complex neurological disorders including epilepsy and multiple sclerosis.',
        chambers: [
          DoctorChamber(name: 'NeuroCare Center', phoneNo: '+1 987 654 3211', address: '88 Brain Ave, Mind City'),
        ],
      ),
    ]);
  }
