...
class StockistNotifier extends StateNotifier<StockistState> {
  ...
  void _loadMockData() async {
    ...
    state = state.copyWith(stockists: [
      const Stockist(
        id: '1',
        name: 'MediCorp Distributors',
        photoPath: 'https://images.unsplash.com/photo-1563213126-a4273aed2016?w=400&q=80',
        address: '200 Industrial Estate, Block C',
        location: 'Mumbai',
        phoneNo: '+91 99887 76655',
        email: 'supply@medicorp.in',
        description: 'MediCorp is one of the largest pharmaceutical distributors in the region, serving over 500 retail pharmacies and hospitals with a diverse portfolio of generic and specialized drugs.',
      ...
      const Stockist(
        ...
        photoPath: 'https://images.unsplash.com/photo-1580982327559-c1202864eb05?w=400&q=80',
        address: '50 Logistics Park, Ring Road',
        location: 'Delhi',
        phoneNo: '+91 88776 65544',
        email: 'orders@primehealth.in',
        description: 'Prime Health specializes in cold chain distribution and bulk supply of essential medicines.',
