...
class ChemistShopNotifier extends StateNotifier<ChemistShopState> {
  ...
  void _loadMockData() async {
    ...
    state = state.copyWith(shops: [
      const ChemistShop(
        id: '1',
        name: 'HealthPlus Pharmacy',
        photoPath: 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=400&q=80',
        address: '101 Wellness Blvd, Sector 4',
        location: 'Mumbai',
        phoneNo: '+91 98765 43210',
        email: 'contact@healthplus.in',
        description: 'HealthPlus is a major retail chain of pharmacies offering a wide range of generic and branded medicines, healthcare products, and wellness supplements.',
        employeeId: 'EMP001',
      ...
      const ChemistShop(
        id: '2',
        name: 'CareWell Meds',
        photoPath: 'https://images.unsplash.com/photo-1576602976047-174e57a47881?w=400&q=80',
        address: '42 Health St, Main Market',
        location: 'Delhi',
        phoneNo: '+91 87654 32109',
        email: 'info@carewell.in',
        description: 'A neighborhood pharmacy serving the local community for over 15 years, specializing in pediatric and geriatric medicines.',
        employeeId: 'EMP002',
