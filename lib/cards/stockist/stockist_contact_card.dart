...
class StockistContactCard extends StatelessWidget {
  ...
  const StockistContactCard({super.key, required this.stockist});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          AppGaps.largeV,
          _buildContactItem(Iconsax.call, 'Phone Number', stockist.phoneNo),
          _buildContactItem(Iconsax.sms, 'Email Address', stockist.email),
          _buildContactItem(Iconsax.location, 'Stockist Address', stockist.address),
        ],
      ),
    );
  }
