...
class ChemistShopSearchFilterCard extends ConsumerWidget {
  const ChemistShopSearchFilterCard({super.key});
          ...
          Row(
            children: [
              Expanded(
                flex: 2,
                child: TextField(
                  onChanged: (val) => ref.read(chemistShopProvider.notifier).setSearchEmployeeQuery(val),
                ...
                child: Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      onChanged: (val) {
                        if (val != null) ref.read(chemistShopProvider.notifier).setFilterLocation(val);
                      },
                    ),
                  ),
                ),
