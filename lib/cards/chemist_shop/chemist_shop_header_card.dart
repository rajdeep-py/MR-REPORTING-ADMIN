...
class ChemistShopHeaderCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final employeeMatches = employees.employees.where((e) => e.id == shop.employeeId).toList();
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          AppGaps.largeV,
          Text(shop.name, style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w800), textAlign: TextAlign.center),
          ...
          Row(
            ...
            children: [
              ...
              Flexible(child: Text(shop.address, style: const TextStyle(color: AppColors.darkGrey, fontWeight: FontWeight.w500), textAlign: TextAlign.center)),
            ],
          ),
          AppGaps.largeV,
