...
class RoutineCard extends StatelessWidget {
  ...
  const RoutineCard({super.key, required this.employee});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(24),
          onTap: () => context.push('${AppRouter.routineDetail}/${employee.id}'),
          child: Padding(
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Row(
                    ...
                    children: [
                      Icon(Iconsax.task_square, size: 18, color: AppColors.black),
                      SizedBox(width: 8),
                      Text(
                        'View & Manage Routine',
