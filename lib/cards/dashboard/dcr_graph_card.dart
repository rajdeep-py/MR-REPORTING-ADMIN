...
class DcrGraphCard extends StatelessWidget {
  final List<MonthlyData> data;
  const DcrGraphCard({super.key, required this.data});
          ...
          Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('DCR Bookings', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800)),
                  const SizedBox(height: 4),
                  const Text('Rise and fall of DCRs per month', style: TextStyle(color: AppColors.darkGrey, fontSize: 13)),
                ],
              ),
              Container(
                ...
                child: const Text('+14%', style: TextStyle(color: Color(0xFF3B82F6), fontWeight: FontWeight.bold, fontSize: 12)),
              ),
            ],
          ),
