...
class OrderSearchFilterCard extends ConsumerWidget {
  const OrderSearchFilterCard({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          TextField(
            onChanged: (val) => ref.read(orderProvider.notifier).setSearchEmployeeQuery(val),
                ...
                child: Container(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      onChanged: (val) {
                        if (val != null) ref.read(orderProvider.notifier).setFilterStatus(val);
                      },
                    ),
                  ),
                ),
              ...
              Expanded(
                ...
                child: InkWell(
                  onTap: () async {
                    ...
                    ref.read(orderProvider.notifier).setDateRange(picked);
                  },
                  child: Container(
                    height: 56,
                    padding: const EdgeInsets.symmetric(horizontal: 16),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (state.dateRange != null)
                          GestureDetector(
                            onTap: () => ref.read(orderProvider.notifier).setDateRange(null),
