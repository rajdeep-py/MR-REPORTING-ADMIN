...
class DoctorContactCard extends StatelessWidget {
  final Doctor doctor;
  const DoctorContactCard({super.key, required this.doctor});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          AppGaps.largeV,
          _buildContactItem(Iconsax.call, 'Phone Number', doctor.phoneNo),
          _buildContactItem(Iconsax.sms, 'Email Address', doctor.email),
          _buildContactItem(Iconsax.location, 'Primary Address', doctor.address),
        ],
      ),
    );
  }
