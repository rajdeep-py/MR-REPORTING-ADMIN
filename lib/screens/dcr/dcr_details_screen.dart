...
class DcrDetailsScreen extends ConsumerWidget {
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      DateFormat('MMMM dd, yyyy').format(dcr.date),
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 18,
                        fontWeight: FontWeight.w700,
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoRow(
            Iconsax.verify,
            'Specialization',
            dcr.doctorSpecialization,
          ),
          _buildInfoRow(
            Iconsax.location,
            'Appointment Location',
            dcr.placeOfAppointment,
          ),
  ...
  Widget _buildVisualAdsBlock(WidgetRef ref, Dcr dcr) {
    ...
    final presentedAds = visualAdsState.ads
        .where((ad) => dcr.presentedVisualAdIds.contains(ad.visualAdId))
        .toList();
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (dcrMatches.isEmpty) {
      return Scaffold(
        ...
        body: const Center(
          child: Text('The Daily Call Report could not be found.'),
        ),
      );
    }
